...
<head>
	...
	<Title>
		White Lake Cheese Portal - Please Login
	</Title>
<?php
session_start();
ob_start();
	...
	<table class="LoginTbl">
		...
		<tr>
			...
			<form method="post" action="">	
				...
				<p class="secText">
				 	Select this option if you are the only person using this computer. This option provides additional time of inactivity before automatically logging you off.<p>
				</div>
			</td>
		</tr>
