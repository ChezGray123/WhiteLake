...
<head>
	...
	<Title>
		White Lake Cheese Portal - First Login > Account Setup
	</Title>
<?php
session_start();
ob_start();
...
<?php
					 ...
					 {
						echo"Username not detected"; //user has not logged into account for first time, shouldnt be possible because of the below condition
						header("location:LoginError.php");
					 }
					 if ($loggedin = 0) //user has not logged into account for first time
					{
						header("location:LoginError.php");
					}
	...
	<table class="LoginTbl">
		...
		<tr>
			<td colspan="2">
			Please create a password for this account. <br>Your Temp password will be removed from our system upon confirmation of your new password. <br>It is your responsibiliy to make a note of this password to gain access to our system. <br>This password must be changed every 6 weeks, you will be prompted to do this upon this deadline being met.
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td >
				Current Password<a href="#adminnotice">*</a>:  
			</td>
			<td>
...
<a name="adminnotice"><p><i><font size="1px" color="red">
	*Please Enter your assigned Temp Password, this will have been emailed to you by a member of staff if you requested it. Please check the email account linked to your new staff account.
	</a></i></font><p>	
</body>
</html>