...
<head>
	...
	<Title>
		White Lake Cheese Portal - Login Error > Account Disabled
	</Title>
<?php
session_start();
ob_start();
...
<body class="login">
	<table class="LoginTbl">
		...
		<tr>
			<td colspan="2">
			<p><i><font size="1px" color="red">Your Account has been Deactivated by a System Admin, please contact an Admin if you think this is being shown in error.</font></i></p>	
			</td>
		</tr>
		<tr>
