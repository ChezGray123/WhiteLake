...
<head>
	...
	<Title>
		White Lake Cheese Portal - Login Error!
	</Title>
<?php
session_start();
ob_start();
...
<body class="login">
	<table class="LoginTbl">
		...
		<tr>
			<td colspan="2">
			<p><i><font size="1px" color="red">An error has occured while trying to login. Please check your login details are correct. If your details are correct, please contact an admin. This error can also occur if you have tried to access the system without logging in.</font></i></p>	
			</td>
		</tr>
		<tr>
			...
			<form method="post" action="">	
				<input type='radio' id='public' value = '0' name='SecCheck' checked="checked"> This is a public or shared computer
				...
				<input type='radio' id='private' value = '1' name='SecCheck'> This is a private computer
